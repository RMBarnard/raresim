...
def parseCommand():
    ...
    subparsers = parser.add_subparsers(
        dest="command", required=True, help="Available commands: sim, convert, extract"
    )
    ...
    calc_parser.add_argument(
        "-o", dest="output", required=True, help="Output file name"
    )
    calc_parser.add_argument(
        "-N",
        dest="n",
    ...
    calc_parser.add_argument(
        "-b", dest="b", help="Scale parameter to estimate the expected AFS distribution"
    )
    calc_parser.add_argument(
        "--nvar_target_data",
    ...
    extract_parser.add_argument(
        "-i", dest="input_file", required=True, help="Input haplotype file (gzipped)"
    )
    extract_parser.add_argument(
        "-o", dest="output_file", required=True, help="Output haplotype file name"
    )
    extract_parser.add_argument(
        "-s", "--seed", dest="seed", type=int, help="Optional seed for reproducibility"
    )
    extract_parser.add_argument(
        "-n",
        dest="num",
    ...
    sim_parser.add_argument(
        "-l", dest="input_legend", required=True, help="Input legend file"
    )
    ...
    sim_parser.add_argument(
        "-H", dest="output_hap", required=True, help="Output compressed haplotype file"
    )
    ...
    convert_parser.add_argument(
        "-i", dest="input_file", required=True, help="Input haplotype file"
    )

    convert_parser.add_argument(
        "-o", dest="output_file", required=True, help="Output haplotype file"
    )
