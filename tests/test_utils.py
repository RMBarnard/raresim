...
from raresim.engine.utils import (add_protected_rows_back,
                                  adjust_for_protected_variants, print_bin)


class TestUtils(unittest.TestCase):
    def setUp(self):
        """Set up test data"""
        self.bins = [(1, 1, 10.0), (2, 2, 5.0), (3, 5, 3.0)]
    ...
    def test_adjust_for_protected_variants(self):
        ...
        protected_vars = adjust_for_protected_variants(
            bins_copy, bin_assignments_copy, legend
        )
    ...
    def test_add_protected_rows_back(self):
        ...
        protected_vars_per_bin = {0: [0, 5], 1: [10], 2: [], 3: []}
